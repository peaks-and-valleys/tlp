...
<ul>
  <li>
    ...
    > : The best platform for artists on the Internet.
  </li>
  <li>
    <a
  ...
  <li>
    <a href="https://ffm.bio/tohlpeaks" rel="external me noopener noreferrer"
      >Other DSPs</a
    > : You can pay for worse quality audio.
  </li>
</ul>
...
<ul>
  ...
  <li>
    ...
    > : I'm not very into it, only for promotional purpose now.
  </li>
  <li>
    <a
      href="https://www.facebook.com/tohlpeaks/"
      rel="external me noopener noreferrer">Facebook</a
    >: I've got so many spam mails from here recently. I'm starting to think
    about closing this.
  </li>
</ul>
<h3 id="contact">Contact</h3>
<p>You can also message me on other apps but my response might be late.</p>
<address>
  <ul>
    <li>
      <a
