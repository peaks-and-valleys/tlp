...
<main>
	<article>
        ...
        <p>I published this page without permissions. If you want to add or remove your website on this page, hit me up (contact info on index page).</p>
        <em>Notice: I will never link to SNS pages. Build your own websites or blogs.</em>
		<h2>Individuals</h2>
		<ul>
			<li>
				<a href="https://www.cannorin.net/" target="_blank">cannorin</a>
			</li>
			<li>
				<a href="https://eulalie.fun/" target="_blank">Eulalie</a>
			</li>
		</ul>
		<h2>Organizations</h2>
        ...
        <ul>
            <li>
                <a href="https://dayofthedroids.wixsite.com/dayofthedroids" target="_blank">Day of the droids</a>
            </li>
            <li>
                <a href="https://sound.jp/fujimi/" target="_blank">Fujimi Industry Records</a>
            </li>
        </ul>
        <h3>Venues</h3>
        <ul>
