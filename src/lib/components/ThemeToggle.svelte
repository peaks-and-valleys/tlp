...
<button onclick={toggleTheme} aria-label="Change color scheme" {...props}>
  {#if $theme === 'dark'}
    <svg
      ...
      /><path d="M12 5l0 -2" /><path d="M17 7l1.4 -1.4" /><path
        d="M19 12l2 0"
      /><path d="M17 17l1.4 1.4" /><path d="M12 19l0 2" /><path
        d="M7 17l-1.4 1.4"
      /><path d="M6 12l-2 0" /><path d="M7 7l-1.4 -1.4" /></svg
    >
  {:else if $theme === 'light'}
    <svg
      xmlns="http://www.w3.org/2000/svg"
