...
<div class="wrapper">
	<ul class="content" aria-label="External links to Tohlpeaks' music and social media">
		...
		<li>
			...
			>
				<svg
					...
					/><path d="M9 8l0 9" /><path d="M6 17l0 -7" /><path d="M3 16l0 -2" /></svg
				>
			</a>
		</li>
		<li>
		...
		<li>
			...
			>
				<svg
					...
					/><path d="M7 9c2 -1 6 -2 10 .5" /></svg
				>
			</a>
		</li>
		<li>
			<a
				href="https://music.apple.com/gb/artist/tohlpeaks/850080183"
				rel="external noopener noreferrer"
			...
			>
				<svg
					...
					/><path d="M12 4a2 2 0 0 0 2 -2a2 2 0 0 0 -2 2" /></svg
				>
			</a>
		</li>
		<li>
		...
		<li>
			<a href="https://x.com/tohlpeaks" rel="external noopener noreferrer" aria-label="X (Twitter)">
				<svg
					xmlns="http://www.w3.org/2000/svg"
					width="24"
					height="24"
